...
CREATE TABLE `proyectos` (
  ...
  `tipo_dato` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  CONSTRAINT `fk_proyectos_created_by` FOREIGN KEY (`created_by`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `fk_proyectos_organizacion` FOREIGN KEY (`organizacion_id`) REFERENCES `organizaciones` (`id`),
  CONSTRAINT `chk_proyectos_estado` CHECK ((`estado` in (_utf8mb4'CREADO',_utf8mb4'CON_DATASETS',_utf8mb4'EN_MAPEO',_utf8mb4'EN_LIMPIEZA',_utf8mb4'PROCESADO',_utf8mb4'ARCHIVADO')))
